...
import (
	...
	"github.com/DIMO-Network/dauth/internal/exchange/api"
...
func (t *ExchangeController) ExchangeToken(w http.ResponseWriter, r *http.Request) {
...
func (t *ExchangeController) tokenReqToAccessReq(tokenReq *TokenRequest) (*access.AccessRequest, error) {
...
func (t *ExchangeController) getPermissionsFromPrivileges(privileges []int64, contractAddress common.Address) ([]string, error) {
