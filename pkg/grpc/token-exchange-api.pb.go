...
// 	protoc        (unknown)
// source: token-exchange-api.proto
...
func (x *AccessCheckRequest) Reset() {
	*x = AccessCheckRequest{}
	mi := &file_token_exchange_api_proto_msgTypes[0]
...
func (*AccessCheckRequest) Descriptor() ([]byte, []int) {
	return file_token_exchange_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *EventFilter) Reset() {
	*x = EventFilter{}
	mi := &file_token_exchange_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EventFilter) Descriptor() ([]byte, []int) {
	return file_token_exchange_api_proto_rawDescGZIP(), []int{1}
}
...
func (x *AccessCheckResponse) Reset() {
	*x = AccessCheckResponse{}
	mi := &file_token_exchange_api_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccessCheckResponse) Descriptor() ([]byte, []int) {
	return file_token_exchange_api_proto_rawDescGZIP(), []int{2}
}
...
func (x *RichError) Reset() {
	*x = RichError{}
	mi := &file_token_exchange_api_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RichError) Descriptor() ([]byte, []int) {
	return file_token_exchange_api_proto_rawDescGZIP(), []int{3}
}
...
var File_token_exchange_api_proto protoreflect.FileDescriptor

const file_token_exchange_api_proto_rawDesc = "" +
	"\n" +
	"\x18token-exchange-api.proto\x12\x04grpc\"\x8f\x01\n" +
	...
	"\vAccessCheck\x12\x18.grpc.AccessCheckRequest\x1a\x19.grpc.AccessCheckResponseB(Z&github.com/DIMO-Network/dauth/pkg/grpcb\x06proto3"

var (
	file_token_exchange_api_proto_rawDescOnce sync.Once
	file_token_exchange_api_proto_rawDescData []byte
)

func file_token_exchange_api_proto_rawDescGZIP() []byte {
	file_token_exchange_api_proto_rawDescOnce.Do(func() {
		file_token_exchange_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_token_exchange_api_proto_rawDesc), len(file_token_exchange_api_proto_rawDesc)))
	})
	return file_token_exchange_api_proto_rawDescData
}

var file_token_exchange_api_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_token_exchange_api_proto_goTypes = []any{
...
var file_token_exchange_api_proto_depIdxs = []int32{
...
func init() { file_token_exchange_api_proto_init() }
func file_token_exchange_api_proto_init() {
	if File_token_exchange_api_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_token_exchange_api_proto_rawDesc), len(file_token_exchange_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_token_exchange_api_proto_goTypes,
		DependencyIndexes: file_token_exchange_api_proto_depIdxs,
		MessageInfos:      file_token_exchange_api_proto_msgTypes,
	}.Build()
	File_token_exchange_api_proto = out.File
	file_token_exchange_api_proto_goTypes = nil
	file_token_exchange_api_proto_depIdxs = nil
}
